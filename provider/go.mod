module github.com/MaienM/pulumi-transip/provider
...
require (
	github.com/aequitas/terraform-provider-transip v0.1.19
...
require (
	...
	github.com/transip/gotransip/v6 v6.16.0 // indirect
